...
# Optionally, set fonts for specific elements (e.g., web pages, tabs)
...
# Set the default font family for websites
c.fonts.web.family.fixed = "JetBrainsMono Nerd Font"  # For monospaced fonts
c.fonts.web.family.sans_serif = "JetBrainsMono Nerd Font"  # For sans-serif fonts
c.fonts.web.family.serif = "JetBrainsMono Nerd Font"  # For serif fonts
c.fonts.web.family.standard = "JetBrainsMono Nerd Font"  # Default standard font

# Optional: You can also set the size if needed
c.fonts.web.size.default = 16  # Set default font size
...
c.content.user_stylesheets = [
    "~/.config/qutebrowser/custom.css",  # For global styles (if any)
]
